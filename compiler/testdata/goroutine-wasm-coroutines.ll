...
; Function Attrs: nounwind
define hidden void @main.startInterfaceMethod(i8* %itf.typecode, i8* %itf.value, i8* %context, i8* %parentHandle) unnamed_addr #0 {
entry:
  ...
  call void @"internal/task.start"(i32 ptrtoint (void (i8*, i8*, i32, i8*, i8*, i8*)* @"interface:{Print:func:{basic:string}{}}.Print$invoke" to i32), i8* nonnull %0, i32 undef, i8* undef, i8* null) #0
  ret void
}

declare void @"interface:{Print:func:{basic:string}{}}.Print$invoke"(i8*, i8*, i32, i8*, i8*, i8*) #1
